...
<template>
  <div class="container px-5">
    <h1 class="my-4 display-1">Ich liebe dich, Amelie!!!</h1>
    <h1>2021</h1>
    ...
    <h1>2022</h1>
    <div id="mygCarousel" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-indicators">
        <button
          type="button"
          data-bs-target="#myCarousel"
