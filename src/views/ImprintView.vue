...
<template>
  <div class="container px-5">
    ...
    <p>
      ...
      <b>Contact: </b><br />
      E-Mail: max.mannstein@gmail.com <br />
      or via the contact form on the website <br />
    </p>
    <p><b>Disclaimer:</b></p>
    ...
    <p>
      ...
      these pages in accordance with § 7 para. 1 of the German Telemedia Act
      (TMG). However, according to §§ 8 to 10 of the TMG, we are not obligated
      ...
      concrete infringement. Upon becoming aware of any such legal violations,
      we will remove the content immediately.
    </p>
    <p><b>Liability for links:</b></p>
    <p>
      Our offer includes links to external third-party websites, over whose
      ...
      content was not recognizable at the time of linking. However, a permanent
      content control of the linked pages is not reasonable without concrete
      evidence of a violation of the law. If we become aware of any legal
    ...
    <p>
      ...
      and any kind of utilization outside the limits of copyright require the
    ...
    <p>
      ...
      data. As far as personal data (e.g., name, address, or email addresses) is
      collected on our pages, this is always done on a voluntary basis, to the
      extent possible. This data will not be disclosed to third parties without
      your explicit consent. We point out that data transmission over the
      Internet (e.g., when communicating by email) may have security
      vulnerabilities. Complete protection of data against access by third
      ...
      prohibited. The operators of the pages expressly reserve the right to take
